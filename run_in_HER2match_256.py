...
subprocess.run([
    "python", "train.py",
    "--dataroot", "/home/ubuntu/zhonghaiqin/dataset/HER2match_1",
    "--model", "sb",
    "--name", "UNSB_HER2match_cropsize_256_loadsize_256",
    "--gpu_ids", "1",
    "--checkpoints_dir", "./checkpoints/HER2match",
    "--display_env", "UNSB_HER2match_cropsize_256_loadsize_256",
    "--crop_size", "256",
    "--load_size", "256",
    "--preprocess", "resize_and_crop",
    "--batch_size", "8",
