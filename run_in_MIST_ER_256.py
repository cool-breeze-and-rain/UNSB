...
subprocess.run([
    "python", "train.py",
    "--dataroot", "/home/ubuntu/zhonghaiqin/dataset/MIST/ER-004/ER/TrainValAB",
    "--model", "sb",
    "--name", "UNSB_MIST_ER_cropsize_256_loadsize_256",
    "--gpu_ids", "5",
    "--checkpoints_dir", "./checkpoints/MIST_ER",
    "--display_env", "UNSB_MIST_ER_cropsize_256_loadsize_256",
    "--crop_size", "256",
    "--load_size", "256",
    "--preprocess", "resize_and_crop",
    "--batch_size", "8",
